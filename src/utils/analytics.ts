...
export const trackROICalculatorInteraction = (databaseSize: number, commission: number, totalROI: number) => {
  trackEvent('roi_calculator_interaction', {
    database_size: databaseSize,
    avg_commission: commission,
    calculated_roi: totalROI,
    event_category: 'engagement',
  });
};

// Track Diagnostic Tool submissions
export const trackDiagnosticSubmission = (toolType: 'call' | 'database') => {
  trackEvent('diagnostic_tool_submission', {
    tool_type: toolType,
    event_category: 'lead_generation',
  });
};

// Track Engine card CTA clicks
export const trackEngineCardClick = (engineName: string) => {
